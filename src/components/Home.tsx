        ...
        <div className="max-w-[650px] items-center justify-center flex flex-col md:gap-10 gap-5 text-center relative avatar">
          ...
          <Fade delay={1400} triggerOnce={true}>
            <p className="text-[#8a8a8a] text-sm md:text-md">
              I am a FullStack | Blockchain developer with 6 years of
              experience. As a blockchain full stack developer, I have
              participated in lot's of full stack and blockchain projects such
              as DApp, DEFI, DEX, DAO, NFT, MARKETPLACE, P2E GAME on various
              blockchains. Most of the time, I am working on Bitcoin, Ethereum,
              BSC, Polygon, Availanche, Venom, Solana, Near and XRP blockchains.
            </p>
          </Fade>
